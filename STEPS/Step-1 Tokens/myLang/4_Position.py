...
class Error:
    ...
    def as_string(self):
        ...
        result += f'sanchika {self.pos_start.fn}, rekha {self.pos_start.ln + 1}'
        return result

class IllegalCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(pos_start, pos_end, 'Awaidh Chinh ', details)
...
class Position:
    ...
    ''' 
        This method moves the position to the next character in the text.
            ...
            - If the current character is a newline (\n), it moves to the  next line (ln) and resets the column to 0 and row to next row.
...
# Define the input text (mathematical expression)
input_text_1 = "3 + 5 * (10$ - 4)"

# Create an instance of the Lexer
lexer_1 = Lexer("example.txt", input_text_1)

# Generate the tokens
tokens_1, error_1 = lexer_1.make_tokens()

# Check for errors
if error_1:
    print(error_1.as_string())
else:
    # Print the tokens
    print(tokens_1)
